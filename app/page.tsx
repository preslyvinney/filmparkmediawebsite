  ...
  return (
    <div className="group text-left [perspective:1600px]">
      <div className="relative z-10 h-full min-h-[31rem] overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.04),rgba(255,255,255,0.01))] p-2 shadow-[0_30px_80px_rgba(0,0,0,0.45)] transition duration-500 hover:-translate-y-1 hover:border-white/20 hover:shadow-[0_35px_100px_rgba(0,0,0,0.6)]">
        ...
        <div
          className="pointer-events-none absolute inset-0 rounded-[2rem] opacity-0 blur-2xl transition duration-500 group-hover:opacity-100"
          style={{
            background:
              "radial-gradient(circle at top, rgba(251,191,36,0.14), transparent 40%), radial-gradient(circle at bottom right, rgba(236,72,153,0.12), transparent 38%), radial-gradient(circle at bottom left, rgba(34,211,238,0.10), transparent 36%)",
          }}
        />
        ...
        >
          <div
            className={`relative h-[22rem] w-full [transform-style:preserve-3d] transition duration-700 ease-out md:group-hover:[transform:rotateY(180deg)] ${
            ...
            <div className="absolute inset-0 overflow-hidden rounded-[1.5rem] [backface-visibility:hidden]">
              <div className={`h-full w-full ${item.cardBg}`}>
                <img
                  ...
                  className={`h-full w-full ${item.fitFront} transition duration-700 md:group-hover:scale-[1.06] ${
                    flipped ? "scale-[1.03]" : ""
                  }`}
                />
              </div>
              <div className="absolute inset-0 bg-[linear-gradient(to_top,rgba(0,0,0,0.52),rgba(0,0,0,0.03),rgba(0,0,0,0.12))]" />
              <div className="absolute inset-x-0 top-0 h-20 bg-gradient-to-b from-white/[0.03] to-transparent" />
              <div className="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-black/20 to-transparent opacity-70 transition duration-500 md:group-hover:opacity-100" />
            ...
            <div className="absolute inset-0 overflow-hidden rounded-[1.5rem] [transform:rotateY(180deg)] [backface-visibility:hidden]">
              <div className={`h-full w-full ${item.cardBg}`}>
                <img
                  src={item.imageBack}
                  alt={`${item.title} back`}
                  className={`h-full w-full ${item.fitBack} transition duration-700 md:group-hover:scale-[1.06] ${
                    flipped ? "scale-[1.03]" : ""
                  }`}
                />
              </div>
...
export default function FilmParkMediaWebsite() {
  ...
  const instagramUrl = "https://www.instagram.com/filmparkmedia/";
  ...
  return (
    <>
      <style>{`
        ...
        .cinematic-overlay {
          animation: cinematicOverlay 0.8s ease-out forwards;
        }
      `}</style>
      ...
      <div className="relative min-h-screen overflow-hidden bg-neutral-950 text-white">
          ...
          {[
            ...
            <div
              ...
              style={{
                left: star.left,
                top: star.top,
                animation: `floatStar ${star.dur} ease-in-out ${star.delay} infinite`,
              }}
            >
              <svg
                viewBox="0 0 100 100"
                className={`${star.size} drop-shadow-[0_0_18px_currentColor]`}
              >
                <path
                  d="M50 4 L58 34 L90 26 L66 50 L90 74 L58 66 L50 96 L42 66 L10 74 L34 50 L10 26 L42 34 Z"
                  fill="currentColor"
                />
              </svg>
            </div>
        ...
        <div className="pointer-events-none fixed inset-0 z-0 bg-[radial-gradient(circle_at_center,transparent_64%,rgba(0,0,0,0.10)_100%)]" />
        ...
        <div className="relative z-10">
                ...
                <div className="relative z-10 flex flex-col justify-center">
                  <div className="mb-4 space-y-3">
                    <p className="text-sm font-semibold uppercase tracking-[0.2em] text-amber-300">
                      Cinematic video for brands that want to stand out
                    </p>
                    <p className="inline-flex w-fit rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-xs font-medium text-white/70 backdrop-blur-sm">
            ...
            <RevealOnScroll>
              <div className="max-w-2xl">
                ...
                <h2 className="mt-3 text-4xl font-black tracking-tight md:text-5xl">
                  You don’t need more random content. You need content that does
                  something.
                </h2>
              </div>
            </RevealOnScroll>
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-3">
              {[
                [
                  ...
                  "Your brand gets a stronger first impression with content that feels cinematic, intentional, and worth watching.",
                ],
                [
                  "Look like a real brand",
                  "Clean visuals, better storytelling, and a polished final product help people trust you faster.",
                ],
                [
                  "Turn ideas into something real",
                  "From pre-production to final edit, you get a process that keeps things moving and a result you’re proud to share.",
                ],
              ].map(([title, desc], idx) => (
              ...
              <RevealOnScroll>
                <div>
                  ...
                  <p className="mt-6 max-w-3xl text-lg leading-8 text-white/[0.72]">
                    ...
                    skipped, forgotten, or barely reaches anyone. When the video
                    falls flat, it doesn’t just hurt the post. It makes your whole
                    brand feel smaller than it really is.
                  </p>
                </div>
              </RevealOnScroll>
            ...
            <div className="grid gap-14">
              <RevealOnScroll>
                <div className="max-w-3xl">
                  <p className="text-sm font-semibold uppercase tracking-[0.2em] text-amber-300">
                    The team behind Film Park Media
                  </p>
                  <h2 className="mt-3 text-4xl font-black tracking-tight md:text-5xl">
                  ...
                  <p className="mt-6 text-lg leading-8 text-white/[0.72]">
                    ...
                    Media feels creative without feeling chaotic.
                  </p>
                </div>
              </RevealOnScroll>
              ...
              <RevealOnScroll>
                <div className="flex flex-col items-start justify-between gap-8 md:flex-row md:items-end">
                  <div className="max-w-2xl">
                    ...
                    <h2 className="mt-3 text-4xl font-black tracking-tight md:text-5xl">
                      Here’s how your idea turns into something people care about.
                    </h2>
                  </div>
                  <a
                    href="#contact"
              ...
              <div className="mt-12 grid gap-6 md:grid-cols-3">
                {[
                  [
                    "01",
                    "Plan the vision",
                    "We figure out the goal, the feel, and what needs to happen before cameras ever turn on.",
                  ],
                  [
                    "02",
                    "Shoot with intention",
                    "Production is focused, smooth, and built around capturing what matters most.",
                  ],
                  [
                    "03",
                    "Deliver content that hits",
                    "You get a final piece that feels polished, memorable, and ready to work for your brand.",
                  ],
          ...
          <section id="services" className="relative z-10 mx-auto max-w-7xl px-6 py-20">
            <RevealOnScroll>
              <div className="max-w-2xl">
                ...
                <h2 className="mt-3 text-4xl font-black tracking-tight md:text-5xl">
                  Pick the kind of project you need. We’ll make sure it actually
                  feels like you.
                </h2>
              </div>
            </RevealOnScroll>
          ...
          <section
            id="portfolio"
            className="relative z-10 border-y border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.015))]"
          >
            <div className="mx-auto max-w-7xl px-6 py-24">
              <RevealOnScroll>
                <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
                  ...
                  <div className="rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-3 text-sm text-white/55 backdrop-blur-sm">
                  ...
                  >
                    <div>
                      ...
                      <input
                        name="name"
                        required
                        className="w-full rounded-2xl border border-white/10 bg-black/40 px-4 py-3 outline-none placeholder:text-white/30 focus:border-amber-300/60"
                    ...
                    <div>
                      ...
                      <select
                        name="projectType"
                        className="w-full rounded-2xl border border-white/10 bg-black/40 px-4 py-3 outline-none focus:border-amber-300/60"
                      >
          ...
          {activeProject && (
            ...
            >
              <div
                className="relative max-h-[90vh] w-full max-w-6xl overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02)),#07090f] shadow-[0_40px_120px_rgba(0,0,0,0.7)]"
                onClick={(event) => event.stopPropagation()}
              >
                <div className="flex items-center justify-between border-b border-white/10 px-5 py-4 md:px-7">
                  <div>
                    <p className="text-[11px] uppercase tracking-[0.24em] text-amber-300/90">
                      ...
                      {activeProject.video ? (
                        <div className="relative h-full w-full">
                          <video
                            ...
                            className="cinematic-video h-full w-full rounded-[1rem] object-contain"
                            autoPlay
                            muted
                            loop
                            playsInline
                          ...
                          />
                          <div className="cinematic-overlay pointer-events-none absolute inset-0 bg-gradient-to-t from-black/30 via-transparent to-black/10" />
                        </div>
                      ) : (
                        <img
